...
-define(DEV(Format, Args),
    mslog_logger:dev(node(), ?MODULE, ?LINE, Format, Args)).
-define(DEV(D),?DEV(D, [])).

-define(DEBUG(Format, Args),
    mslog_logger:debug_msg(node(), ?MODULE,?LINE,Format, Args)).
-define(DEBUG(D), ?DEBUG(D, [])).

-define(INFO_MSG(Format, Args),
    mslog_logger:info_msg(node(), ?MODULE,?LINE,Format, Args)).
-define(INFO_MSG(D), ?INFO_MSG(D, [])).

-define(WARNING_MSG(Format, Args),
    mslog_logger:warning_msg( node(), ?MODULE,?LINE,Format, Args)).
-define(WARNING_MSG(D), ?WARNING_MSG(D, [])).

-define(ERROR_MSG(Format, Args),
    mslog_logger:error_msg( node(), ?MODULE,?LINE,Format, Args)).
-define(ERROR_MSG(D), ?ERROR_MSG(D, [])).

-define(CRITICAL_MSG(Format, Args),
    mslog_logger:critical_msg( node(), ?MODULE,?LINE,Format, Args)).
